package org.example.realtime.dwd.db.spllt.app;
...
import org.example.realtime.common.util.FlinkSinkUtil;
import org.example.realtime.common.util.FlinkSourceUtil;
import org.example.realtime.dwd.db.spllt.function.BaseDbTableProcessFunction;

/**
 * @Package org.example.realtime.dwd.db.spllt.app.DwdBaseDb
 * @Author song.lihao
 * @Date 2025/4/8 22:46
 * @description:
 */
